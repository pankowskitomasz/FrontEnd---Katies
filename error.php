...
<head>
	...
	<![endif]-->
    <meta property="og:title" content="Katie cafe">
...
<body>
    ...
    <section class="container-fluid gallery-s-2 d-flex" id="msg">
        <div class="row my-auto w-100 d-flex my-3 mx-auto">
            <div class="col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2 p-4 my-auto mx-auto bg-white opacity-9">
                <div class="row pb-3">
                    <h3 class="section-title text-uppercase text-center m-0">Error!</h3>
                </div>
                <div class="row">
                    <div class="spacer">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <p class="lead text-center">
                            Your message has not been sent. Please try again later or contact 
                            us  by phone.
                        </p>
                    </div>
                </div>
